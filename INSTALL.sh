...
cd EukMetaSanity/scripts/final-annotations && cargo build --release && cd - || return
ln -srf EukMetaSanity/scripts/*.py bin/
ln -srf EukMetaSanity/scripts/*.sh bin/
ln -srf EukMetaSanity/scripts/final-annotations/target/release/final-annotations bin/
