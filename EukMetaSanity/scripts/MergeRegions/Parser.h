...
#ifndef MERGEREGIONS_PARSER_H
#define MERGEREGIONS_PARSER_H
...
class Parser : public Genome {
public:
    // Constructor generate translation table and fasta file map
    Parser(const std::string& gff3_file, const std::string& fasta_file, const MergeType& mt = MergeType::CONFIRM)
